...
- Added `Registry` module for type-safe index registration and lookup.

## [1.1.1] - 2026-01-26

### Changed

- Added `protected readonly ICapacityStrategy CapacityStrategy;` field to `KeyAssociation<TKey, TValue>` class for better extensibility
